...
python3 weight_matrix_creator.py --target prediction --strategy $CI_STRATEGY --foresight $CI_FORESIGHT --prefix pre1  --learning 1 --hyper $CI_HYPER --cool $CI_COOLDOWN
python3 weight_matrix_creator.py --target prediction --strategy $CI_STRATEGY --foresight $CI_FORESIGHT --prefix pre2 --learning 0.7 --hyper $CI_HYPER --cool $CI_COOLDOWN
...
python3 weight_matrix_creator.py --target prediction --strategy $CI_STRATEGY --foresight $CI_FORESIGHT --prefix pre8  --learning 0.001 --hyper $CI_HYPER --cool $CI_COOLDOWN
